...
> **Where it's available**　In China: <a href="https://jimeng.jianying.com" target="_blank">Jimeng (即梦)</a>, <a href="https://xyq.jianying.com" target="_blank">Xiaoyunque (小云雀)</a>, <a href="https://www.liblib.tv/" target="_blank">LibTV</a>; Overseas: <a href="https://dreamina.capcut.com" target="_blank">Dreamina (Jimeng's global edition)</a>, <a href="https://www.capcut.com" target="_blank">CapCut</a>, <a href="https://cv.cm/v" target="_blank">CV.CM (no queue)</a>, <a href="https://higgsfield.ai/" target="_blank">Higgsfield</a>.
...
- **Generate Seedance 2.0 storyboard prompts**: adaptively use a timeline or shot-sequence format based on the user's source material, target duration, and platform limits; audio-visual integrated and copy-paste ready.
- **Multi-episode series planning**: segment and manage continuity based on the user's requested episode count, total duration, and publishing platform; no default forced split into fixed 15-second chunks or fixed episode counts.
...
- **12 production iron rules + anti-pollution principle** (top of SKILL.md, highest priority): respect the user's task first and do not force every project into a short-drama SOP; also covers duration/segment math, continuation-ghosting reinforcement, no-subtitle rule, dialogue timeline alignment, moderation avoidance, TTS dubbing pitfalls, action separability, two-person hand locking, output formatting, voice-line locking, **cinematic-language first**, **prompt-as-visual-language / de-AI-look**.
