...
AI 人物面部真实感关键词库见 [references/portrait-realism-details.md](references/portrait-realism-details.md)（由抖音「AI视觉真实感系列」啊布 蒸馏，专攻人物「一眼假→一眼真」）：

- 一眼假的根因不在五官、在「太干净太完美」；真实感 = 可控的不完美
- 面部局部特写关键词库（眼睛 / 嘴唇 / 鼻子+脸颊，每条照抄即用）+ 通用增强词（细腻光影 / 高清细节 / 电影质感）
